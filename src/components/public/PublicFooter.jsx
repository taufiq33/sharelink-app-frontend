    ...
    <footer className="mb-50 sm:mb-20 mt-20 h-20 border-t grid grid-cols-1 sm:grid-cols-2 gap-5 md:grid-cols-3 md:gap-3 text-sm p-4 text-stone-500">
      <div className="brand-footer flex gap-2 flex-col md:flex-row justify-center items-center">
        ...
        <p className="text-center md:text-left">
          &copy; 2025 ShareLink App. All rights reserved.
        </p>
      </div>
      <div className="navigation-footer flex flex-col sm:flex-row gap-2 justify-center items-center ">
        <Link to="#">About</Link>
        <Link to="#">Contact</Link>
        <Link to="#">Terms of Service</Link>
        <Link to="#">Privacy Policy</Link>
      </div>
      <div className="mt-2 action-footer flex gap-4 items-center justify-end sm:col-span-2 sm:justify-self-center md:col-span-1 md:justify-items-end">
        <svg
          className="w-4 h-4 hover:text-[#0866FF]"
          role="img"
          viewBox="0 0 24 24"
        ...
        <svg
          className="w-4 h-4  hover:text-[#FF0069]"
          role="img"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
        >
